...
import ec.edu.espe.thefamse.controller.DataBaseController;
...
public class ReportExcel {
    ...
    public synchronized static ReportExcel getInstance (){
        if (instance != null){
        } 
        else {
    ...
    public void generateReport() {
        ...
        try {
            InputStream is = new FileInputStream("src\\main\\resources\\1am.png");
